...
class Api_user extends RestController {
     ...
     public function search_get()
    {
        ...
        if($username === null){
            $data = $this->api_m->get_user()->result();
        }else{
            $data = $this->api_m->get_username($username)->result();
        }
    ...
    public function index_get()
    {
        ...
        if($id === null){
            ...
            $data = $this->api_m->get_user($id)->result();
        }
    ...
    public function index_put()
    {
        ...
        $this->api_m->edit_user($post, $id_user);
        if($this->db->affected_rows()>0){
                $this->response([
                'status' => true,
